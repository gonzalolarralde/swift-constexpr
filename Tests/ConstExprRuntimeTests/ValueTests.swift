...
private class OptionalBaseValue {}
private final class OptionalDerivedValue: OptionalBaseValue {}
private struct OpaqueCollectionValue: Equatable {
    let id: Int
}

protocol ErasedRepresentableValue {}

private struct ProtocolRepresentableValue: ErasedRepresentableValue, ConstExprRepresentable {
...
private protocol PrivateStructuralProtocol {}

private struct PrivateStructuralValue: PrivateStructuralProtocol, ConstExprRepresentable {
    func constExprExpression() throws -> ExprSyntax {
        "PrivateStructuralValue()"
    }
}

private class PrivateStructuralBase: ConstExprRepresentable {
    func constExprExpression() throws -> ExprSyntax {
        "PrivateStructuralBase()"
    }
}

private final class PrivateStructuralDerived: PrivateStructuralBase {
    override func constExprExpression() throws -> ExprSyntax {
